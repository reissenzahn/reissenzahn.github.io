...
- [A Load Balancer from scratch – Liz Rice, Isovalent](https://www.youtube.com/watch?v=L3_AOFSNKK8)
...
- [libtorrent Blog: asynchronous disk I/O](https://blog.libtorrent.org/2012/10/asynchronous-disk-io/)
- [Lord of the io_uring](https://unixism.net/loti/index.html)

### Containers
- [Container Security](https://a.co/d/70ljlXc)
- [Building a Linux Container using Namespaces](https://www.polarsparc.com/xhtml/Containers-1.html)
...
- [Queuing System Discrete Event Simulation in Python](https://www.youtube.com/watch?v=eSNfC-HOl44)
- [Inventory System Discrete Event Simulation in Python](https://www.youtube.com/watch?v=Kmu9DNQamLw)
- [Factory System Discrete Event Simulation in Python](https://www.youtube.com/watch?v=G2WftFiBRFg&t=1120s)
